...
function Main() {
	return (
		<div className="main-body">
			...
			{/* <Container className="text-center pt-5 border">
				<h3>Отправляйте заказы</h3>
				<div>
					В данном сервисе вы можете легко создать заказы и отправлять их. Для этого только
					необходимо заполнить простую форму
				</div>
			</Container>
			<Container className="text-center pt-5 border">
				<h3>Отслеживайте свои заказы</h3>
				<div>
					Если вы заказали в каком-либо магазине товар мы можете легко посмотреть всю информацию по
					текущему заказу, включая местоположение курьера
				</div>
			</Container>
			<Container className="text-center pt-5 border">
				<h3>Управляйте заказамы и курьерами</h3>
				<div>
					Вы легко можете просматривать и администровать все заказы через учетную запись
					администратора
				</div>
			</Container> */}
			<Container className="text-center pt-5">
